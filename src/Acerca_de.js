        ...
        <View style={styles.container}>
            <PaperProvider>
                ...
                <ScrollView>
                    ...
                    <View>
                        <Text style={styles.text}>
                            La Escuela de Ingeniería Mecánica es una unidad académica de
                            la Escuela Superior Politécnica de Chimborazo; en
                            la actualidad se encuentra en la implantación de su modelo de
                            gestión aplicando conceptos tecnológicos para el mejor 
                            desenvolvimiento de actividades académicas.
                        </Text>
                    </View>
                    <View>
                        <Text style={styles.text}>
                            La aplicación MecApp, cumple el objetivo de acercar a la
                            escuela a todas sus partes interesadas y establecer un nexo de
                            comunicación alineado a las nuevas herramientas tecnológicas
                            para satisfacer todos los requerimientos de información, así
                            como comunicar las noticias,  actividades desarrolladas, oferta académicas,
                    ...
                    <View>
                        <Text style={styles.text}>
                            ...
                            Aportando a la innovación y los planes de mejora existentes 
                            en la Escuela de Ingeniería Mecánica de la ESPOCH.{" "}
                        </Text>
                    </View>
                </ScrollView>
                <Divider />   
                <View style={styles.footer1}>
                    ...
                    <Chip 
                        style = {{ backgroundColor: "#FAE8E6", marginTop: 8, marginLeft: 10,}}
                        textStyle ={{fontSize: 13}}
                        height= {34}
                        width = {110}
                        mode = "outlined"
